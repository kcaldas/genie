...
Prefer DeepSeek? The low-cost `deepseek-flash` and `deepseek-v4-pro` models are supported natively:
```bash
export GENIE_LLM_PROVIDER="deepseek"
export DEEPSEEK_API_KEY="sk-your-api-key"
export GENIE_MODEL_NAME="deepseek-flash"   # or "deepseek-v4-pro"
