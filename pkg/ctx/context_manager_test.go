...
func TestContextManager_CanBeCreatedWithChatCtxManager(t *testing.T) {
	// Create event bus
	eventBus := events.NewEventBus()
	...
	// This should compile and create a context manager with both managers
	manager := NewContextManagerWithChatCtx(projectCtxManager, chatCtxManager)
